...
if __name__ == '__main__':
    ...
    # lr_list = [0.0001, 0.0002, 0.0003, 0.0004, 0.0005]
    # gs_bcgd_fixed_1 = GS_BCGD(max_iterations=10000, learning_rate_strategy='constant', learning_rate=lr_list[0])
    # gs_bcgd_fixed_1.name = 'LR Fixed ' + str(gs_bcgd_fixed_1.learning_rate)
    # gs_bcgd_fixed_2 = GS_BCGD(max_iterations=10000, learning_rate_strategy='constant', learning_rate=lr_list[1])
    # gs_bcgd_fixed_2.name = 'LR Fixed ' + str(gs_bcgd_fixed_2.learning_rate)
    # gs_bcgd_fixed_3 = GS_BCGD(max_iterations=10000, learning_rate_strategy='constant', learning_rate=lr_list[2])
    # gs_bcgd_fixed_3.name = 'LR Fixed ' + str(gs_bcgd_fixed_3.learning_rate)
    # gs_bcgd_fixed_4 = GS_BCGD(max_iterations=10000, learning_rate_strategy='constant', learning_rate=lr_list[3])
    # gs_bcgd_fixed_4.name = 'LR Fixed ' + str(gs_bcgd_fixed_4.learning_rate)
    # gs_bcgd_fixed_5 = GS_BCGD(max_iterations=10000, learning_rate_strategy='constant', learning_rate=lr_list[4])
